...
Table: (\#tab:unnamed-chunk-1)Merging with 4 nested runs

| Run| Pass_ratio|maxdist    |nmin       |nmax           |Input_data                                                |Output_data |
|---:|----------:|:----------|:----------|:--------------|:---------------------------------------------------------|:-----------|
|   1|       1.00|4          |8          |16             |Initial input (E.g.: Bias adjusted rainfall gridded data) |Output 1    |
|   2|       0.75|4*0.75 = 3 |8*0.75 = 6 |16 * 0.75 = 12 |Output 1                                                  |Output 2    |
|   3|       0.50|4*0.5 = 2  |8*0.5 = 4  |16*0.5 = 12    |Output 2                                                  |Output 3    |
