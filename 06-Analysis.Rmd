...
data2 = data.frame(Value = c("2 or more", "1.55-1.99", "1-1.49", "-0.99-0.99", "-1.0-1.49", "-1.5--1.99", "-2 or less"), Classification = c("Extremely wet", "Severely wet", "Moderately wet", "Near normal", "Moderately dry", "Severely dry", "EZxtremely dry"))
knitr::kable(data2, digits = 3, format.args = list(scientific = FALSE), caption = "SPI classification")
```
...
```{r echo = FALSE, warning = FALSE}
options(knitr.kable.NA = "")
data2 = data.frame(Value = c("Deciles 1-2 (lowest 20%)", "Deciles 3-4 (next lowest 20%)", "Deciles 5-6 (middle 20%)","Deciles 7-8 (next highest 20%)", "Deciles 9-10 (hihhest 20%)"), Classification = c("Much above normal", "Below normal", "Near normal", "Above normal", "Much above normal"))
knitr::kable(data2, digits = 3, format.args = list(scientific = FALSE), caption = "Deciles classification")
```
