...
6. Select the number of columns containing the climate variable.
    ...
    a. For daily data, there are 2 possible formats:
        * 1 column: the climate variable is placed in a single column.
        ...
        knitr::kable(data2, digits = 3, format.args = list(scientific = FALSE), caption = "Daily data: 1 column format")
        ```
...
knitr::kable(data2, digits = 3, format.args = list(scientific = FALSE), caption = "Dekadal data -- 1 column")
```
...
knitr::kable(data2, digits = 3, format.args = list(scientific = FALSE), caption = "Dkadal data -- 3 columns")
```
...
knitr::kable(data2, digits = 3, format.args = list(scientific = FALSE), caption = "Monthly data -- 1 column")
```
